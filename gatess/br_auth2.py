...
import requests
      ...
      #  "http": "http://rxsdusfn-rotate:pih5bayjb0du@p.webshare.io:80/",
        #"https": "http://rxsdusfn-rotate:pih5bayjb0du@p.webshare.io:80/"

host = 'p.webshare.io'
port = 80
user = 'rxsdusfn-rotate'
passs = 'pih5bayjb0du'

#requests.get(
    #"https://ipv4.webshare.io/",
   # proxies={
      #  "http": "socks5h://rxsdusfn-rotate:pih5bayjb0du@p.webshare.io:80/",
      #  "https": "socks5h://rxsdusfn-rotate:pih5bayjb0du@p.webshare.io:80/"
   # }
#).text
...
def Tele(cx):
    ...
    get=r.get("https://www.woolroots.com/my-account/",headers=heaf, proxies=proxies)
    ...
    response = r.post('https://www.woolroots.com/my-account/', headers=headers, data=data, proxies=proxies)
    ...
    'Sec-Fetch-User': '?1',
    'Upgrade-Insecure-Requests': '1',
    'User-Agent': 'Mozilla/5.0 (Linux; Android 11; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',
    'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-platform': '"Android"',
}

    response = r.get('https://www.woolroots.com/my-account/add-payment-method/',headers=headers, proxies=proxies)
#print(response.text)
    ...
    response = r.post('https://www.woolroots.com/wp-admin/admin-ajax.php', headers=headers, data=data, proxies=proxies)
    #print(response.text)
    ...
    ges=r.get("https://www.woolroots.com/my-account/add-payment-method/",headers=gh, proxies=proxies)
    ...
    time.sleep(25)
    response = r.post('https://www.woolroots.com/my-account/add-payment-method/', headers=headers, data=data, proxies=proxies)
