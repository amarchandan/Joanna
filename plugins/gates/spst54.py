...
@Client.on_message(filters.command("ssc1"))
async def cmd_spst54(Client, message):
    try:
...
━━━━━━━━━
 ...
 Response - Wait.....
              ...
              """
                            ...
                            authurl = f"https://teammorpho.xyz/api/shopifystripe54.php?lista={fullcc}"
