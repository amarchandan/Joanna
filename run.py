...
"""
                                    ...
                                    if (
                                        e
                                        == 'Telegram says: [400 USER_ALREADY_PARTICIPANT] - The user is already a participant of this chat (caused by "messages.ImportChatInvite")'
                                    ):
                                        ...
                                        try:
                                            ...
                                            async for msg in user.get_chat_history(
                                                ...
                                                for item in cards:
                                                    ...
                                                    file_name = (
                                                        f"{limit}x_By_@JoannaChkBot.txt"
                                                    )
                                                    with open(file_name, "a") as f:
                                                        cclist = (
                                                            open(f"{file_name}")
...
"""
                                        ...
                                        e
                                        == 'Telegram says: [400 INVITE_HASH_EXPIRED] - The chat invite link is no longer valid (caused by "messages.ImportChatInvite")'
                                    ):
...
"""
                                    ...
                                    if (
                                        e
                                        == "Error : local variable 'file_name' referenced before assignment"
                                    ):
                                        resp = "No CC Found"
                                        await bot.delete_messages(
                                            message.chat.id, delete.id
                                        ...
                                        await message.reply_text(
                                            text=resp, reply_to_message_id=message.id
                                        )
                                    elif (
                                        e
                                        ...
                                        e
                                        == "local variable 'file_name' referenced before assignment"
                                    ):
                                        resp = "No CCs Found ❌"
                                        await bot.delete_messages(
                                            message.chat.id, delete.id
                                        ...
                                        await message.reply_text(
                                            text=e, reply_to_message_id=message.id
                                        )
